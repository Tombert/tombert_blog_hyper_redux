...
> These benchmarks are flawed because the JVM is a bit weird.  Skip this post and read [[Posts/Technical/2025/03 March/Microbenchmarks - JMH and Corrections\|this]] one instead. 



This will be a relatively short post, but after my [[Posts/Technical/2025/03 March/Microbenchmarks - Java Locks vs. Atomics\|benchmarking post]] with locks, I became a bit curious about the performance of [BlockingQueues](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/BlockingQueue.html).
