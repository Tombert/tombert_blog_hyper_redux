...
Open source to the rescue! [Quartz](https://quartz.jzhao.xyz/) is a tool that takes an Obsidian Vault and converts it into a static website, while preserving the links, hierarchy and graph that you would expect in Obsidian.  It even has a fairly decent search built in...a lot better than the [[Posts/Technical/2025/03 March/Making a Shitty 'Search Engine' in Hugo\|shitty one that I made for Hugo]]. 
