...
Recently I released the [[The Quest for Concurrent DOS Part 1 \| the first part of my adventure]] trying to find the ownership and and source code to Digital Research's Concurrent DOS (also known as Multiuser DOS, with a separate spinoff product called REAL/32). 
...
> Hi Thomas, You are right Datapac did have a licence to Concurrent DOS but it is no longer trading we sold it to Citrix. The original code was acquired from Digital Research by Novell. You would have to see if you can track down where all the Novell IP landed. Good luck with the search and please let me know if you ever do get to the source code.
> Cheers!
