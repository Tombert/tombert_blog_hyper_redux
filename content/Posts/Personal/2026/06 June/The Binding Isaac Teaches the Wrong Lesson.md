---
{"publish":true,"title":"The Binding of Isaac Teaches the Wrong Lesson","created":"2026-06-21T06:22:44-04:00","modified":"2026-06-22T20:01:46.710-04:00","tags":["personal"],"cssclasses":""}
---
...
This is why most of the moral lessons we learn about as children ([even the stuff in the Bible](https://en.wikipedia.org/wiki/Parable_of_the_Prodigal_Son)) tend to focus on *non-obvious* morality.  The stories don't generally boil down to "stealing is bad", or "murder is wrong", but instead bring up a scenario that is specifically *not* intuitive. 

For example, the [famous "Scorpion and the Frog" story](https://en.wikipedia.org/wiki/The_Scorpion_and_the_Frog) teaches a non-obvious lesson.  Intuition would tell us that the scorpion's assured death would prevent him from stinging the frog.  Instead, the scorpion is unable to resist stinging the frog, despite the fact that doing so ensures that they *both* die.   
...
As far as I can tell, the lesson effectively boils down to "if something or someone bigger and stronger than you tells you to do something you don't like...do it anyway." Ignore your own ethical morality: if God tells you to do something, even something that [he himself contradicted later](https://en.wikipedia.org/wiki/Thou_shalt_not_kill), you should do it. 
...
Every human will be handed countless ethical dilemmas throughout their existence.  We all are responsible for our own actions, and we all build our own moral framework based on our experiences and the media we consume.  The Bible is claimed to be the [ultimate source of morality](https://answersingenesis.org/morality/the-source-of-moral-absolutes/) by a large quantity of people.  By teaching terrible lessons, we're teaching terrible morality to many people. 
