...
You keep ownership of your comment, but you grant **Tombert** a **worldwide, non-exclusive, royalty-free, transferable, sublicensable license** to use, reproduce, display, distribute, and create derivative works from your comment **to operate, maintain, improve, moderate, and promote Tombert's Blog**, including showing your comment alongside the relevant post and in archives/backups.

## 4) Moderation and removals (my discretion)
...
Tombert does not guarantee that comments will be published, retained, or remain available. Tombert's Blog and comment system are provided “as is”.
...
Questions about comments or moderation: [[Contact]]

# Privacy Notice (Tombert’s Blog)
